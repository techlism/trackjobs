...
export const IndividualColumn: React.FC<IndividualColumnProps> = ({
	...
	return (
		<div
			...
			} min-w-[250px] mx-auto sm:min-w-[350px] md:min-w-[450px] lg:min-w-[550px] xl:min-w-[750px]`}
		>
			...
			<ScrollArea className="h-[55dvh] px-2">
				...
				{jobs.map((job) => (
					<div
						key={job.id}
						className={"mb-2 mx-2 max-w-[99.8%] hover:scale-[1.02] transition-all duration-150 hover:rounded-md hover:shadow-sm"}
					>
						<div
